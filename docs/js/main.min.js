...
"use strict";function init(){this.$=require("jquery/dist/jquery"),this.jQuery=this.$,require("svg4everybody/dist/svg4everybody")(),require("retinajs/dist/retina"),$(document).ready(function(){})}require("core-js/modules/es6.function.bind"),init.bind(window)();
